...
@Component({
    ...
    template: `
        <div class="planning-page">
            <h1 class="page-title">{{ 'employee.planning.title' | transloco }}</h1>
            <mat-tab-group animationDuration="150ms">
                <mat-tab [label]="'employee.planning.openingHours' | transloco">
                    <div class="tab-content">
                        <app-availability></app-availability>
                    </div>
                </mat-tab>
                <mat-tab [label]="'employee.planning.blockedSlots' | transloco">
                    <div class="tab-content">
